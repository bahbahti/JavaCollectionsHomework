...
y=dlmread('addclass java.util.ArrayList.txt');
...
ylabel('Time (nanosec)')
legend('LinkedList', 'ArrayList');


z=dlmread('getclass java.util.ArrayList.txt');
...
h=dlmread('removeclass java.util.ArrayList.txt');
